...
module.exports = {
  ...
  getFoto18: async function(username, key) {
    return fetchData(/18/foto_18, username=${username}&key=${key});
  },
  
  getVideo18: async function(username, key) {
    return fetchData(/18/video, username=${username}&key=${key});
  },
